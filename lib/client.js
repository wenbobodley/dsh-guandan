	...
	factory: (require) => {
		...
		if (typeof document !== "undefined" && document.querySelector('style[data-plugin-css="' + STYLE_ID + '"]') === null) {
			...
			tag.textContent = [
				...
				".gd-overlay-panel{background:var(--dsw-alias-surface-main,#1b1d22);color:var(--dsw-alias-label-primary,#e8e8e8);border:1px solid var(--dsw-alias-border-l3,#333);border-radius:14px;width:min(680px,96vw);max-height:88vh;overflow:auto;padding:14px 16px;position:relative;box-shadow:0 12px 40px rgba(0,0,0,.5)}",
				".gd-close{position:absolute;top:10px;right:12px;cursor:pointer;background:none;border:none;color:var(--dsw-alias-label-tertiary,#888);font:inherit;font-size:16px;padding:4px 8px;border-radius:6px}",
				".gd-close:hover{color:var(--dsw-alias-label-primary,inherit)}",
				...
				".gd-card{display:inline-flex;flex-direction:column;align-items:center;justify-content:center;min-width:38px;height:54px;border-radius:7px;background:#fff;border:1px solid #d8d8d8;box-shadow:0 2px 4px rgba(0,0,0,.35);cursor:pointer;user-select:none;padding:3px 2px;line-height:1.05;transition:transform .08s}",
				".gd-card:hover{transform:translateY(-2px)}",
				".gd-card.sel{outline:3px solid #3b82f6;transform:translateY(-6px)}",
				".gd-card-rank{font-weight:800;font-size:15px}",
				".gd-card-suit{font-size:13px;margin-top:1px}",
				".gd-red{color:#d2232a}",
				".gd-black{color:#1a1a1a}",
				".gd-joker-big{color:#d2232a}",
				".gd-joker-small{color:#444}",
				".gd-actions{display:flex;gap:8px;margin-top:6px;align-items:center;flex-wrap:wrap;position:sticky;bottom:0;background:var(--dsw-alias-surface-main,#1b1d22);padding:6px 0;z-index:2}",
