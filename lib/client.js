	...
	factory: (require) => {
		...
		if (typeof document !== "undefined" && document.querySelector('style[data-plugin-css="' + STYLE_ID + '"]') === null) {
			...
			tag.textContent = [
				...
				".gd-card{display:inline-flex;align-items:center;justify-content:center;min-width:32px;height:42px;border:1px solid var(--dsw-alias-border-l3,#555);border-radius:6px;background:var(--dsw-alias-surface-mid,#fff);cursor:pointer;user-select:none;padding:0 5px;box-shadow:0 1px 2px rgba(0,0,0,.2);font-size:14px}",
